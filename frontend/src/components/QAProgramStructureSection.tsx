...
export default function QAProgramStructureSection() {
  const features = [
    ...
    { icon: Video, label: 'Weekly Live Sessions with AI Labs' },
    { icon: Code, label: 'Hands-On Projects: 2 mid-program + 1 capstone' },
      ...
      <div className="container">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="bg-accent/10 border border-accent/20 rounded-lg p-6 text-center space-y-2">
            ...
            <p className="text-muted-foreground">Every week includes applied labs and AI tool integration.</p>
          </div>
        </div>
      </div>
    </section>
